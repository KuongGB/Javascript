...
//muốn truy cập vào [[Protoype]] dùng __proto__
...
//set [[Prototype]]
//giả sử anh xét cho [[prototype]] của rabbit thành rỗng
// rabbit.__proto__ = {};
Object.setPrototypeOf(rabbit, {}); // thế kỷ 21
console.log(rabbit);
...
//giờ ta có con rabbit nếu như bây giờ anh muốn clone lại nó
console.log(rabbit);

let objClone = {...rabbit};
console.log(objClone);
//ko đc cờ và cả [[Prototype]]
objClone = Object.defineProperties({},Object.getOwnPropertyDescriptors(rabbit));
console.log(objClone);
//ko đc [[Prototype]]
objClone = Object.create(Object.getPrototypeOf(rabbit), Object.getOwnPropertyDescriptors(rabbit));
console.log(objClone)
//ngon
...
Tại sao _proto_ bị thay thế bởi các hàm getPrototypeOf/setPrototypeOf? Đây là một câu hỏi thú vị, đòi hỏi chúng ta phải hiểu tại sao _proto_ khá tệ. Đọc thêm để biết câu trả lời. "very plain Object" để hiểu rỏ tại sao nó tệ
...
//string ko thể trở thành 1 [[Prototype]]
obj = {};
let key = prompt("Nhập vào key", "__proto__")
obj[key] = "giá trị bất kì"
console.log(obj);
//__proto__ chỉ có thể là null hoặc object dạng bình thường, chứ k thể là 1 string
...
Vì thế chúng ta có thể sử dụng Object.create(null) để tạo một "very plain" object mà không có _proto_, hoặc chuyển qua Map object.
